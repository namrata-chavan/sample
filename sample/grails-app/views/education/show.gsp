	...
	<body>
		...
		<div id="show-education" class="content scaffold-show" role="main">
			...
			<ol class="property-list education">
				...
				<g:if test="${educationInstance?.education}">
				<li class="fieldcontain">
					<span id="education-label" class="property-label"><g:message code="education.education.label" default="Education" /></span>
					
						<span class="property-value" aria-labelledby="education-label"><g:fieldValue bean="${educationInstance}" field="education"/></span>
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="education.name.label" default="Name" /></span>
						...
						<span class="property-value" aria-labelledby="name-label"><g:link controller="person" action="show" id="${educationInstance?.name?.id}">${educationInstance?.name?.encodeAsHTML()}</g:link></span>
